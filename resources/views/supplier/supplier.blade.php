<x-app-layout>
 ...
 <div class="pb-3" style="display: flex; justify-content: space-between; align-items: center;">
   <div>
       <p class="fs-4 font-semibold" style="color: rgb(73, 73, 243);">Data Supplier</p>
   </div>
   <div>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                              <div class="text-center">
                                <a href='{{ url('supplier/'.$supp->kode.'/edit') }}' class="btn btn-primary btn-sm">Edit</a>
                                <form onsubmit="return confirm('Apakah anda yakin ingin menhapus item ini?')" class='d-inline' action="{{ url('supplier/'.$supp->kode) }}" method="post">
                                  @csrf
                                  @method('DELETE')
