...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased" >
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900 custom-login-background" style="background-image: url('images/background.jpg'); background-size:cover;">
            <div>
                <a href="/">
                    <img src="{{ asset('images/Logo Super.png') }}" alt="Logo" width="100" height="100" >
                </a>
            </div>
            <a class="font-semibold justify-content-center text-white" style="font-size: 35px;">Sumber Rahayu</a>

            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-transparent dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg" style="background-size:cover; border: 2px solid rgba(255,255,255,0.5); border-radius: 20px; backdrop-filter: blur(15px);">
                {{ $slot }}
            </div>
        </div>
    </body>
